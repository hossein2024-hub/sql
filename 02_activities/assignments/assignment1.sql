...
-- Step 1: Create the temporary table and copy data from the original vendor table
...
-- Step 2: Insert the new 10th vendor into the temp table
...
,customer_first_name
,customer_last_name
,ROUND(SUM(quantity * cost_to_customer_per_qty), 2) AS April_2022_spent
